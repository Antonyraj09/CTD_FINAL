...
public interface IDashboardService
{
    ...
    Task<IReadOnlyList<RouteCountDto>> GetRouteVolumeAsync(CancellationToken ct = default);
    ...
    Task<CustomerCommercialDto> GetCustomerCommercialAsync(int importerId, CancellationToken ct = default);
